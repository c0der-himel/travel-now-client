...
const MyBookingsDetails = ({ booking, handleDeleteBooking }) => {
  const {
    _id,
    userName,
    userEmail,
  ...
  return (
    <tbody className="bg-white divide-y divide-gray-200">
      <tr>
        ...
        <td className="px-6 py-4 whitespace-nowrap">
          <span className="px-4 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-500">
            {status}
          </span>
        </td>
